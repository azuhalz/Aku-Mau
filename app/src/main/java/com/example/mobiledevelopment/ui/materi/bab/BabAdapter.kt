...
import com.example.mobiledevelopment.ui.materi.konten.KontenMateriActivity
...
.Adapter<BabAdapter.BabHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BabAdapter.BabHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(
            R.layout.item,
            parent, false)
        return BabAdapter.BabHolder(view)
    }

    override fun onBindViewHolder(holder: BabAdapter.BabHolder, position: Int) {
